...
function HigherOrLower3() {
    let card4= Math.floor(Math.random() * 13) + 1;
    console.log(card4);
...
function HigherOrLower4() {
    let card5= Math.floor(Math.random() * 13) + 1;
    console.log(card5);
